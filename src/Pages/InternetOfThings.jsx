...
import internetOfThings from './images/iot.webp'
...
const InternetOfThings = () => {
  return (
    <>
     <Helmet>
        <title>Internet Of Things Services - TechnoGripper Solutions Private Limited</title>
      </Helmet>
      <EnterpriseSolutionHeader headerData={headerData} imgSource={internetOfThings}/>
