...
const serviceData = [
  {
    ...
    heading: "Cloud-based LMS",
    description:
      "Streamline course management, content delivery, and student engagement, providing a comprehensive platform for online learning and blended learning environments.",
  },
  {
    icon: <GiCoinflip />,
    heading: "eLearning Apps",
    description:
      "Extend learning beyond the classroom with mobile apps that offer access to educational resources, interactive activities, progress tracking, and communication channels for seamless anytime, anywhere learning.",
  },
  {
    icon: <GiCoins />,
    heading: "Virtual Classroom",
    description:
      "Enable interactive and immersive virtual classrooms with features such as live video streaming, real-time collaboration, and content sharing for seamless remote education experiences.",
  },
  {
    icon: <PiGenderTransgenderThin />,
    heading: "Educational ERP",
    description:
      "Centralize ERP having student data management, including enrollment, attendance, grades, and communications, enhancing administrative efficiency and facilitating data-driven decision-making.",
  },
];
const faqArray = [
  {
...
const BankingAndFinance = () => {
  return (
    <>
     <Helmet>
        <title>Banking & Finance Services - TechnoGripper Solutions Private Limited</title>
      </Helmet>
